...
```html
<script src="https://tracemind.super-tree.com/capture.js" data-tracemind-token="tm_proj_xxx" async></script>
```
...
```html
<script
  src="https://tracemind.super-tree.com/capture.js"
  data-tracemind-token="tm_proj_xxx"
  data-tracemind-endpoint="https://tracemind.super-tree.com/api/capture"
  async>
</script>
```
...
```text
https://tracemind.super-tree.com/mcp?mcpToken=tm_mcp_xxx
```
...
```text
script-src https://tracemind.super-tree.com
connect-src https://tracemind.super-tree.com
```
