...
Use statuses such as `drafted_for_approval`, `awaiting_user_approval`, `approved_to_reply`, `commented`, `commented_verified_search_state`, `commented_unverified`, `replied`, `blocked`, `skipped`, `skipped_by_user`, and `needs_rewrite`.
