<script>
  ...
  <section id="how" class="workflow">
    ...
    <p class="supported-platforms">{$t("Supported platforms: Web · iOS · macOS · Android · React Native · Hybrid (Electron / Tauri / Capacitor / Cordova) · Mini Program (WeChat / Alipay / Douyin / DingTalk) · Server · MCP · Agent Skill")}</p>
  </section>
