...
- 如果 Appinn / 小众软件已登录，提交 `开发者自荐` 投稿；否则保持为登录阻塞，不消耗主要 outreach 时间。
...
- 投稿入口：`https://meta.appinn.net/new-topic?category=10`
...
- Appinn / 小众软件：0-1 条，仅用于提交已确认的 `开发者自荐` 投稿；不做日常批量评论。
...
- [ ] 检查小红书 2 条评论反馈。
- [ ] 检查少数派 MioKit 评论反馈。
- [ ] 如果 Appinn 已登录，提交 `docs/appinn_submission_2026-05-17.md`；如果未登录，记录阻塞即可。
- [ ] 回复所有高意向互动。
