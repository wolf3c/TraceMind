...
- 检查所有已发帖和已评论内容的反馈信号。
- 推进 1 个愿意继续沟通或试点的人，优先跟进 X Vibe Coding Community 中 Johnny Nel 的 medium-signal 互动。
- 新增 4-6 条高质量公开回复，优先小红书有效搜索态和明确求反馈的 V2EX / X 产品帖，宁缺毋滥。
- 清理图片上传阻塞；只有在用户确认发布原创新帖且上传权限已解除时，才在小红书发布带图试点招募帖。
- 检查 Appinn / 小众软件 `开发者自荐` 投稿是否通过审核；若仍在审核，不重复提交。
- 复盘哪类人、哪句话、哪个平台更接近真实种子客户；不要把浏览量等同于意向。
...
- 已评论候选：
  ...
  - `https://www.v2ex.com/t/1213280?p=1#reply3`
  - `https://www.v2ex.com/t/1213275?p=1#reply5`

X：

- 主帖：`https://x.com/old_farmer_/status/2055893615612924388`
- 中文主帖：`https://x.com/old_farmer_/status/2055922795939565621`
- Vibe Coding Community：`https://x.com/i/communities/1898129646782497027`
- Johnny Nel follow-up reply：`https://x.com/old_farmer_/status/2055939454217638329`
...
- 发现频道：`https://meta.appinn.net/c/faxian/10`
- 投稿文案：`docs/appinn_submission_2026-05-17.md`
- 当前状态：2026-05-17 已提交，等待版主审核。
...
注意：小红书原创新帖属于新公开发布。即使下面文案已经准备好，也只在当天用户确认后发布；未确认时只检查上传能力和保留文案。
...
- 小红书：2-3 条，主攻 A0 ICP；若直达页被 gating，改用有效搜索态或移动端确认，不强行重复打开直达链接。
- 即刻：0-1 条，先确认上一批评论是否真实可见，再找 vibe coding 产品和 AI 工具作者。
- V2EX：1-2 条，只选明确求反馈、产品上线、或正在讨论用户行为验证的帖子。
- X：1-2 条，优先 Vibe Coding Community 中对 post-launch behavior analysis 有共鸣的讨论。
- 少数派：0-1 条，只在文章上下文非常匹配时评论。
- Appinn / 小众软件：只检查已提交自荐帖审核状态；不重复提交，不做日常批量评论。
...
- [ ] 检查小红书 2 条评论反馈。
- [ ] 检查少数派 MioKit 评论反馈。
- [ ] 检查 Appinn 自荐帖是否通过审核；若仍在审核，记录即可。
- [ ] 回复所有高意向互动。
